...
export default function Landing() {
  ...
  return (
    <>
      <div
        id="home"
        className="overflow-hidden flex flex-col px-4 md:flex-row gap-12
          items-center md:items-start md:justify-center justify-start h-full md:h-[95vh] w-full relative bg-cover bg-center sm:bg-contain"
        style={{
